...
async def start_handler(c, m):
    ...
    lazydeveloper_btn = [[
        InlineKeyboardButton('𝗞𝗮𝗻𝗻𝗮𝗱𝗮 𝗥𝗼𝗰𝗸𝗲𝗿𝘀', url='https://t.me/+eevc5ZGpwEIzM2Zl')
    ]]
...
async def req_accept(c, m):
    ...
    try: 
        lazydeveloper_btn = [[
        InlineKeyboardButton('🎬. MOVIE UPDATES .🍟', url='https://t.me/+SmCC9tqxv0ExODE1')
        ]] 
