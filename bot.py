...
ACCEPTED_TEXT = "Hi {user}\nYour Request For {chat} Is Accepted ✅ 𝐉𝐎𝐈𝐍: @Kr_Cinemagalu_2025\n\n{user} 𝗦𝗘𝗡𝗗 👉 /start To Get 𝗞𝗮𝗻𝗻𝗮𝗱𝗮 𝗥𝗼𝗰𝗸𝗲𝗿𝘀 𝗠𝗼𝘃𝗶𝗲𝘀 Updates\n\n 𝗝𝗼𝗶𝗻👇👇\nhttps://t.me/+c0l7pBiLK0YxYzJl\nhttps://t.me/+c0l7pBiLK0YxYzJl"
...
async def start_handler(c, m):
    ...
    lazydeveloper_btn = [[
        InlineKeyboardButton('𝗞𝗮𝗻𝗻𝗮𝗱𝗮 𝗥𝗼𝗰𝗸𝗲𝗿𝘀', url='https://t.me/+c0l7pBiLK0YxYzJl')
    ]]
...
async def req_accept(c, m):
    ...
    try: 
        lazydeveloper_btn = [[
        InlineKeyboardButton('🎬. MOVIE UPDATES .🍟', url='https://t.me/+UFMQgsKgiARjYjg1')
        ]] 
